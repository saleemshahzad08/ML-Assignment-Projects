...
Original file is located at
    https://colab.research.google.com/drive/16IFsIw5nRqFaMxXUqU2wRcyKmMVZbGPs
"""
...
model = joblib.load('Project-02-Classification/01-Adult-Income-Predictor/model.pkl')

st.title('Income Level Predictor')

st.write("'Predict an adult's income category using machine learning! Classify income as <=50K or >50K based on factors like age, education, occupation, and more.")
...
if st.button("Predict"):
    ...
    if prediction == 1:
        ...
        st.write(
            f"**Probability of Income >50K:** "
            f"{probability[1]:.2%}"
        )

    else:

        st.error("The income is predicted to be less thanor equal to 50,000.")
